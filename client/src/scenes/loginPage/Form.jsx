...
// yup validation schema (the shape of how the form library is saving the info)
...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    // this allows form info with image to be sent
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {/* Section for both login and register */}
            <TextField
              label="Email"
              onBlur={handleBlur}
              onChange={handleChange}
